...
<body style="background-color:powderblue;">
    <div class="profile_container">
        ...
        <nav>
            <ul>
                <li><a href="profile.php" rel="noopener noreferrer">All Users</a></li>
                ...
                if($get_frnd_num > 0){
                    foreach($get_all_friends as $row){
                        echo '<div class="user_box">
                                ...
                                <span><a href="user_profile.php?id='.$row->id.'" class="see_profileBtn">See profile</a>               <a href="msg.php?id='.$row->id.'" class="chatBtn">Chat</a></div>
                            </div>';
                    }
                }
                else{
