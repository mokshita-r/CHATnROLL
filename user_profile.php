    ...
    <div class="profile_container">
        ...
        <div class="inner_profile">
            ...
            <ul>
                ...
                <li><a href="./includes/classes/friend.php" rel="noopener noreferrer">Logout</a></li>
            </ul>
        </nav>
            <div class="actions">
                <?php
                if($is_already_friends){
                    ...
                    echo '<br><br>';
                    echo '<a href="functions.php?action=unfriend_req&id='.$user_data->id.'" class="req_actionBtn unfriend">Unfriend</a>   <a href="msg.php?id='.$user_data->id.'" class="chatBtn">Chat</a>';
                }
